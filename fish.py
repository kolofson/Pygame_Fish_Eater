...
game_over_msg2 = small_font.render("Click to play again!", True, "red")
...
def redraw_window():
    ...
    if lost:
        ...
        screen.blit(game_over_msg2, (WIDTH / 2, HEIGHT / 4))
...
while running:
    ...
    if len(enemies) == 0:
        ...
        for i in range(wave_length):
            enemy = Enemy(0, random.randrange(0, HEIGHT - 100), random.randint(0, 2))
